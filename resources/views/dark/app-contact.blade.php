...
@section('pageContent')
          ...
          @include('layouts.breadcrumb', ['title' => 'Contact', 'subtitle' => 'Home'])
                ...
                <table class="table search-table align-middle text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="{{ URL::asset('build/images/profile/user-2.jpg') }}" alt="avatar" class="rounded-circle"
                            width="35" />
                          <div class="ms-3">
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="{{ URL::asset('build/images/profile/user-3.jpg') }}" alt="avatar" class="rounded-circle"
                            width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="{{ URL::asset('build/images/profile/user-4.jpg') }}" alt="avatar" class="rounded-circle"
                            width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="{{ URL::asset('build/images/profile/user-5.jpg') }}" alt="avatar" class="rounded-circle"
                            width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
                    ...
                    <tr class="search-items">
                      ...
                      <td>
                        <div class="d-flex align-items-center">
                          <img src="{{ URL::asset('build/images/profile/user-12.jpg') }}" alt="avatar" class="rounded-circle"
                            width="35" />
                          <div class="ms-3">
                            <div class="user-meta-info">
...
@section('scripts')
  ...
  <script src="{{ URL::asset('build/js/apps/contact.js') }}"></script>
@endsection
