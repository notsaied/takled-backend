...
@section('pageContent')
          ...
          @include('layouts.breadcrumb', ['title' => 'Chat', 'subtitle' => 'Home'])
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <img src="{{ URL::asset('build/images/profile/user-1.jpg') }}" alt="user1" width="54" height="54"
                  ...
                  <ul class="chat-users mb-0 mh-n100" data-simplebar>
                      ...
                      <a href="javascript:void(0)"
                        ...
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="{{ URL::asset('build/images/profile/user-3.jpg') }}" alt="user1" width="48" height="48"
                              class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                    ...
                    <li>
                      <a href="javascript:void(0)"
                        ...
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="{{ URL::asset('build/images/profile/user-2.jpg') }}" alt="user-2" width="48" height="48"
                              class="rounded-circle" />
                    ...
                    <li>
                      <a href="javascript:void(0)"
                        ...
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="{{ URL::asset('build/images/profile/user-8.jpg') }}" alt="user-8" width="48" height="48"
                              class="rounded-circle" />
                    ...
                    <li>
                      <a href="javascript:void(0)"
                        ...
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="{{ URL::asset('build/images/profile/user-4.jpg') }}" alt="user-4" width="48" height="48"
                              class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                    ...
                    <li>
                      <a href="javascript:void(0)"
                        ...
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="{{ URL::asset('build/images/profile/user-6.jpg') }}" alt="user1" width="48" height="48"
                              class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                        ...
                        <div class="chat-box-inner p-9" data-simplebar>
                          <div class="chat-list chat active-chat" data-user-id="1">
                            <div class="hstack gap-3 align-items-start mb-7 justify-content-start">
                              <img src="{{ URL::asset('build/images/profile/user-8.jpg') }}" alt="user8" width="40" height="40"
                                class="rounded-circle" />
                              <div>
                            ...
                            <div class="hstack gap-3 align-items-start mb-7 justify-content-start">
                              ...
                              <div>
                                ...
                                <div class="rounded-2 overflow-hidden">
                                  <img src="{{ URL::asset('build/images/products/product-1.jpg') }}" alt="modernize-img" class="w-100" />
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="offcanvas-body p-9">
                            ...
                            <div class="row mb-7 text-nowrap">
                              <div class="col-4 px-1 mb-2">
                                ...
                                <img src="{{ URL::asset('build/images/products/product-1.jpg') }}" width="88" height="65" alt="modernize-img"
                                  class="rounded" />

                              </div>
                              <div class="col-4 px-1 mb-2">

                                <img src="{{ URL::asset('build/images/products/product-2.jpg') }}" width="88" height="65" alt="modernize-img"
                                  class="rounded" />

                              </div>
                              <div class="col-4 px-1 mb-2">

                                <img src="{{ URL::asset('build/images/products/product-3.jpg') }}" width="88" height="65" alt="modernize-img"
                                  class="rounded" />

                              </div>
                              <div class="col-4 px-1 mb-2">

                                <img src="{{ URL::asset('build/images/products/product-4.jpg') }}" width="88" height="65" alt="modernize-img"
                                  class="rounded" />
                            ...
                            <div class="files-chat">
                              ...
                              <a href="javascript:void(0)"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="{{ URL::asset('build/images/chat/icon-adobe.svg') }}" alt="modernize-img" width="24"
                                      height="24" />
                                  </div>
                                  <div>
                              ...
                              <a href="javascript:void(0)"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="{{ URL::asset('build/images/chat/icon-figma.svg') }}" alt="modernize-img" width="24"
                                      height="24" />
                                  </div>
                                  <div>
                                    <h6 class="fw-semibold">
                              ...
                              <a href="javascript:void(0)"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="{{ URL::asset('build/images/chat/icon-chrome.svg') }}" alt="modernize-img" width="24"
                                      height="24" />
                                  </div>
                                  <div>
                              ...
                              <a href="javascript:void(0)"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="{{ URL::asset('build/images/chat/icon-zip-folder.svg') }}" alt="modernize-img" width="24"
                                      height="24" />
                                  </div>
                                  <div>
                                    <h6 class="fw-semibold">
                              ...
                              <a href="javascript:void(0)"
                                ...
                                <div class="d-flex align-items-center gap-3">
                                  <div class="rounded-1 text-bg-light p-6">
                                    <img src="{{ URL::asset('build/images/chat/icon-javascript.svg') }}" alt="modernize-img" width="24"
                                      height="24" />
                                  </div>
                                  <div>
                  ...
                  <ul class="chat-users mh-n100" data-simplebar>
                    <li>
                      <a href="javascript:void(0)"
                        ...
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="{{ URL::asset('build/images/profile/user-2.jpg') }}" alt="user1" width="48" height="48"
                              class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                    ...
                    <li>
                      <a href="javascript:void(0)"
                        ...
                        <div class="d-flex align-items-center">
                          <span class="position-relative">
                            <img src="{{ URL::asset('build/images/profile/user-7.jpg') }}" alt="user1" width="48" height="48"
                              class="rounded-circle" />
                            <span class="position-absolute bottom-0 end-0 p-1 badge rounded-pill bg-success">
                              <span class="visually-hidden">New alerts</span>
                            </span>
