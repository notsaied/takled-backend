...
@section('pageContent')
          ...
          @include('layouts.breadcrumb', ['title' => 'Contact Application', 'subtitle' => 'Home'])
                  ...
                  <div class="border-end user-chat-box h-100">
                    ...
                    <div class="app-chat">
                      <ul class="chat-users mh-n100" data-simplebar>
                        <li>
                          <a href="javascript:void(0)"
                            ...
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-3.jpg') }}" alt="user-4" width="40" height="40"
                        ...
                        <li>
                          <a href="javascript:void(0)"
                            class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_2"
                            data-user-id="2">
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-5.jpg') }}" alt="user4" width="40" height="40"
                                class="rounded-circle">
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)"
                            class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_3"
                            data-user-id="3">
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-6.jpg') }}" alt="user3" width="40" height="40"
                                class="rounded-circle">
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)"
                            class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_4"
                            data-user-id="4">
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-7.jpg') }}" alt="user8" width="40" height="40"
                                class="rounded-circle">
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)"
                            class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_5"
                            data-user-id="5">
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-8.jpg') }}" alt="user2" width="40" height="40"
                                class="rounded-circle">
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)"
                            class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_6"
                            data-user-id="6">
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-9.jpg') }}" alt="user1" width="40" height="40"
                                class="rounded-circle">
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)"
                            class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_7"
                            data-user-id="7">
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-11.jpg') }}" alt="user3" width="40" height="40"
                                class="rounded-circle">
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)"
                            class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_8"
                            data-user-id="8">
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-8.jpg') }}" alt="user1" width="40" height="40"
                                class="rounded-circle">
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                        ...
                        <li>
                          <a href="javascript:void(0)"
                            class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_9"
                            data-user-id="9">
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-9.jpg') }}" alt="user1" width="40" height="40"
                                class="rounded-circle">
                        ...
                        <li>
                          <a href="javascript:void(0)"
                            class="px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user" id="chat_user_10"
                            data-user-id="10">
                            <span class="position-relative">
                              <img src="{{ URL::asset('build/images/profile/user-12.jpg') }}" alt="user1" width="40" height="40"
                                class="rounded-circle">
                            </span>
                            <div class="ms-6 d-inline-block w-75">
                            ...
                            <div class="chat-box email-box mh-n100 p-9"
                              ...
                              <div class="chat-list chat active-chat" data-user-id="1">
                                <div
                                  ...
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="{{ URL::asset('build/images/profile/user-3.jpg') }}" alt="user4" width="72"
                              ...
                              <div class="chat-list chat" data-user-id="2">
                                <div
                                  class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="{{ URL::asset('build/images/profile/user-5.jpg') }}" alt="user4" width="72"
                                      height="72" class="rounded-circle">
                                    <div>
                              ...
                              <div class="chat-list chat" data-user-id="3">
                                <div
                                  class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="{{ URL::asset('build/images/profile/user-6.jpg') }}" alt="user3" width="72"
                                      height="72" class="rounded-circle">
                                    <div>
                              ...
                              <div class="chat-list chat" data-user-id="4">
                                <div
                                  class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="{{ URL::asset('build/images/profile/user-7.jpg') }}" alt="user8" width="72"
                                      height="72" class="rounded-circle">
                                    <div>
                              ...
                              <div class="chat-list chat" data-user-id="5">
                                <div
                                  class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="{{ URL::asset('build/images/profile/user-8.jpg') }}" alt="user2" width="72"
                                      height="72" class="rounded-circle">
                                    <div>
                              ...
                              <div class="chat-list chat" data-user-id="6">
                                <div
                                  class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="{{ URL::asset('build/images/profile/user-9.jpg') }}" alt="user1" width="72"
                                      height="72" class="rounded-circle">
                                    <div>
                              ...
                              <div class="chat-list chat" data-user-id="7">
                                <div
                                  class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="{{ URL::asset('build/images/profile/user-11.jpg') }}" alt="user3" width="72"
                                      height="72" class="rounded-circle">
                                    <div>
                              ...
                              <div class="chat-list chat" data-user-id="8">
                                <div
                                  class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="{{ URL::asset('build/images/profile/user-8.jpg') }}" alt="user1" width="72"
                                      height="72" class="rounded-circle">
                                    <div>
                              ...
                              <div class="chat-list chat" data-user-id="10">
                                <div
                                  class="hstack align-items-start mb-7 pb-1 align-items-center justify-content-between">
                                  <div class="d-flex align-items-center gap-3">
                                    <img src="{{ URL::asset('build/images/profile/user-12.jpg') }}" alt="user1" width="72"
                                      height="72" class="rounded-circle">
                                    <div>
