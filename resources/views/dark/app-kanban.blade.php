...
@section('pageContent')
          ...
          @include('layouts.breadcrumb', ['title' => 'Kanban', 'subtitle' => 'Home'])
          <div
                    ...
                    <div class="connect-sorting connect-sorting-todo">
                      <div class="task-container-header">
                        ...
                        <div class="hstack gap-2">
                          ...
                          <div class="dropdown">
                            <a class="dropdown-toggle" href="javascript:void(0)" role="button" id="dropdownMenuLink-1"
                        ...
                        <div data-draggable="true" class="card img-task">
                          <div class="card-body">
                            ...
                            <div class="task-content p-0">
                              <img src="{{ URL::asset('build/images/backgrounds/kanban-img-1.jpg') }}" class="img-fluid"
                                alt="scrumboard">
                            </div>
                            <div class="task-body">
                      ...
                      <div class="connect-sorting-content" data-sortable="true">
                        ...
                        <div data-draggable="true" class="card img-task">
                          <div class="card-body">
                            ...
                            <div class="task-content p-0">
                              <img src="{{ URL::asset('build/images/backgrounds/kanban-img-2.jpg') }}" class="img-fluid"
                                alt="scrumboard">
                            </div>
                            <div class="task-body">
                              <div class="task-bottom">
                      ...
                      <div class="connect-sorting-content" data-sortable="true">
                        ...
                        <div data-draggable="true" class="card img-task">
                          <div class="card-body">
                            ...
                            <div class="task-content p-0">
                              <img src="{{ URL::asset('build/images/backgrounds/my-card.jpg') }}" class="img-fluid"
                                alt="scrumboard">
                            </div>
                            <div class="task-body">
                              <div class="task-bottom">
                      ...
                      <div class="connect-sorting-content" data-sortable="true">
                        <div data-draggable="true" class="card img-task">
                          <div class="card-body">
                            ...
                            <div class="task-content p-0">
                              <img src="{{ URL::asset('build/images/backgrounds/profilebg.jpg') }}" class="img-fluid"
                                alt="scrumboard">
                            </div>
                            <div class="task-body">
                              <div class="task-bottom">
...
@section('scripts')
  ...
  <script src="{{ URL::asset('build/js/apps/kanban.js') }}"></script>
@endsection
