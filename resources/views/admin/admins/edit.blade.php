...
<div class="card">
            <div class="card-body">
              ...
              <form id="example-form" method="POST" action="{{ route('admin.administrators.update',['id' => $admin->id]) }}" class="mt-5" novalidate="novalidate">
                <div role="application" class="wizard clearfix" id="steps-uid-1"><div class="content clearfix">
                  ...
                  <section id="steps-uid-1-p-0" role="tabpanel" aria-labelledby="steps-uid-1-h-0" class="body current" aria-hidden="false">
                    ...
                    <input id="name" value="{{ $admin->name }}" name="name" type="text" class="required form-control mb-3" autocomplete="on">

                    <label class="form-label" for="userName">Username</label>
                    <input id="username" value="{{ $admin->username }}" name="username" type="text" class="required form-control mb-3" autocomplete="on">
