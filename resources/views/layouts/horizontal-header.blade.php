<nav class="navbar navbar-expand-xl container-fluid p-0">
  <ul class="navbar-nav align-items-center">
    ...
    <li class="nav-item d-none d-xl-block">
      <a href="main/index" class="text-nowrap nav-link">
        <img src="{{ URL::asset('build//images/logos/logo.png') }}" class="dark-logo" width="180" alt="modernize-img" />
        <img src="{{ URL::asset('build//images/logos/logo.png') }}" class="light-logo" width="180" alt="modernize-img" />
      </a>
    </li>
  ...
  <div class="d-block d-xl-none">
    <a href="main/index" class="text-nowrap nav-link">
      <img src="{{ URL::asset('build//images/logos/logo.png') }}" width="180" alt="modernize-img" />
    </a>
  </div>
