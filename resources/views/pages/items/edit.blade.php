                    ...
                    <div class="col-12">
                        <form action="{{ route('items.update', $item->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                @if ($item->image)
                                    <div class="mt-2">
                                        <img width="100" height="100" src="{{ $item->image }}" alt="Current Image"
                            ...
                            <div class="mb-3">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="name" id="name"
                                        placeholder="Enter Name here" value="{{ old('name', $item->name) }}">
                            ...
                            <div class="mb-3">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="calorie" id="calories"
                                        placeholder="Calories" value="{{ old('calorie', $item->calorie) }}">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input placeholder="Price" name="price" type="text" class="form-control"
                                    aria-label="Amount (to the nearest dollar)" value="{{ old('price', $item->price) }}">
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3 d-flex gap-2 align-items-center justify-content-between border-bottom py-2">
                                                <label class="form-label mb-0">{{ $ingredient->name }}</label>

                                                @php
                                                    $itemIngredient = $itemIngredients->firstWhere('id', $ingredient->id);
                                                @endphp

                                                <input type="number" class="d-block form-control" style="width: 16% !important"
                                                       name="ingredients[{{ $ingredient->id }}]"
                                                       value="{{ $itemIngredient ? $itemIngredient['pivot']['quantity'] : '' }}">
                                            </div>
                                        @empty
                                            <p>No ingredients available.</p> <!-- يمكن إضافة رسالة هنا في حال كانت القائمة فارغة -->
                                        @endforelse
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button"
                                                class="btn bg-success text-white  waves-effect text-start"
