                    ...
                    <form action="{{ route('items.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name here" value="{{ old('name') }}">
                        ...
                        <div class="mb-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="calorie" id="calories" placeholder="Calories" value="{{ old('calories') }}">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input placeholder="Price" name="price" type="text" class="form-control" aria-label="Amount (to the nearest dollar)" value="{{ old('price') }}">
                        </div>
